    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">รายได้ทั้งหมด</h3>
            </div>
...
<script>
    ...
    table = $dt.DataTable({
        ...
        columnDefs : [
            ...
            //         __url = __url.replace('__id', full.user_id);
            //         if(full.user_id){
    ...
    $(document).on('click', '.btn-cancel', function(e){
        ...
        Swal.fire({
            title: `ยกเลิกรายได้<br>เลขที่ #${__id}`,
            icon: `warning`,
            ...
            if (result.isConfirmed) {
                var __url = `{{ route('incomes.cancel','__id') }}`;
                ...
                $.ajax({
                    ...
                    Swal.fire(`ยกเลิกรายได้เรียบร้อย`, ``, `success`);
                    table.draw();
                    loader.close();
    ...
    $(document).on('click','.show-slip', function(e){
        ...
        element = `
            ...
            <div class="user-block d-inline-block w-100 mt-4">
                <img class="img-circle bbg-logo mr-4" src="${img_bbg}" alt="User Image">
                <span class="username">BA system</span>
            ...
            <div class="user-block d-inline-block w-100">
                <div class="avatars rounded-circle avatars-sm border-green  float-left mr-4 ">
                    <div class="avatars-one" style="background-image: url(${ (data.user.image == null) ? img_default : data.user.image })"></div>
                </div>
                <span class="username">${ data.user.first_name+' '+data.user.last_name }</span>
                <span class="description">รหัสผู้ขาย  #${ data.user.code }</span>
            </div>
